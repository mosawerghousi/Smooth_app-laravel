...
<html lang="en">
  <head>
    ...
    <link rel="shortcut icon" type="x-icon" href="{{ URL('storage/smooth_icon.png')}}">
  ...
  <body>
    <header class="header-bar mb-3">
      <div class="container d-flex flex-column flex-md-row align-items-center p-3">
        <h4 class="my-0 mr-md-auto font-weight-normal"><a href="/" class="text-white">Smooth_App <img src="{{ URL('storage/smooth_icon.png')}}" alt="Unavailable"></a></h4>
        @auth
        <div class="flex-row my-3 my-md-0">
          <a href="/search/{$term}" class="text-white mr-2 header-search-icon" title="Search" data-toggle="tooltip" data-placement="bottom"><i class="fas fa-search"></i></a>
          <span class="text-white mr-2 header-chat-icon" title="Chat Room" data-toggle="tooltip" data-placement="bottom"><i class="fas fa-comment"></i></span>
 ...
 @endif
    ...
    <footer class="border-top text-center small text-muted py-3">
        <p class="m-0">Copyright &copy; {{ date('Y')}} <a href="/" class="text-muted">Smooth_App</a>. All rights reserved.</p>
      </footer>
        @auth
