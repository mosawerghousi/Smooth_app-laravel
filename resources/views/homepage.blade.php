        ...
        <div class="col-lg-5 pl-lg-5 pb-3 py-lg-5">
          <form action="/register" method="POST" id="registration-form">
            ...
            <div class="form-group">
              ...
              <input value="{{old('username')}}" name="username" username-register class="form-control" type="text" placeholder="Pick a username" autocomplete="off" />
              @error('username')
          ...
          @enderror
            ...
            <button type="submit" class="py-3 mt-4 btn btn-lg btn-success btn-block">Sign up for Smooth_App</button>
          </form>
        </div>
      </div>
    </div>
