...
class UserController extends Controller
{
    public function storeAvatar(Request $request) {
        ...
        return back()->with('success', 'New Avatar Successfully setted!');
    }
    ...
    public function aboutUs() {
        ...
        return view('about', ['postCount' => $postCount], ['userCount' => $userCount]);
    ...
    public function loginApi(Request $request) {
        ...
        if (auth()->attempe($incomingFields)) {
    ...
    public function login(Request $request) {
       ...
       if (auth()->attempt(['username' => $incomingFields['loginusername'], 'password' => $incomingFields['loginpassword']])){
        ...
        return redirect('/')->with('success', 'You have successfully looged in.');
       } else {
        return redirect('/')->with('failure', 'Username or Password is incorrect!');
       }
    }
    ...
    public function register(Request $request) {
        ...
        auth()->login($user);
        return redirect('/')->with('success', 'Thanks for Joining US !');
    }
